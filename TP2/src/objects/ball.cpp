...
void setBallParameters() {
	...
	ballCol[0].initPos.y = InitialBallPos.y - 4.0f;
	ballCol[0].initPos.x = InitialBallPos.x;

	ballCol[1].initPos.x = InitialBallPos.x + 4.0f;
	ballCol[1].initPos.y = InitialBallPos.y;

	ballCol[2].initPos.y = InitialBallPos.y + 4.0f;
	ballCol[2].initPos.x = InitialBallPos.x;

	ballCol[3].initPos.x = InitialBallPos.x - 4.0f;
